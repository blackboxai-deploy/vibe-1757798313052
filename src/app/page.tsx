...
const greetings = [
  ...
  { language: "French", text: "Bonjour Monde", flag: "🇫🇷" },
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4 py-20">
        ...
        <div className="text-center space-y-8 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Welcome to our modern Hello World app! Experience greetings from around the world with beautiful animations and interactive features.
          </p>
